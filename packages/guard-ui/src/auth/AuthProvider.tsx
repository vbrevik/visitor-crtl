...
const DEV_USERS: Record<string, AuthUser> = {
  "guard.olsen": {
    ...
    firstName: "Erik",
    lastName: "Olsen",
    email: "erik.olsen@forsvaret.no",
    roles: ["guard"],
    accessToken: "dev-token-guard",
    attributes: { employee_id: "FD-2001", site_id: "SITE-A" },
  },
  "guard.larsen": {
    sub: "dev-guard-larsen",
    name: "Thomas Larsen",
    firstName: "Thomas",
    lastName: "Larsen",
    email: "thomas.larsen@forsvaret.no",
    roles: ["guard"],
    accessToken: "dev-token-guard-b",
    attributes: { employee_id: "FD-2002", site_id: "SITE-B" },
  },
};
