...
const DEV_USERS: Record<string, AuthUser> = {
  "security.berg": {
    sub: "dev-security-berg",
    name: "Ingrid Berg",
    firstName: "Ingrid",
    lastName: "Berg",
    email: "ingrid.berg@forsvaret.no",
    roles: ["security_officer"],
    accessToken: "dev-token-security",
    attributes: { employee_id: "FD-3001", site_id: "SITE-A", security_level: "HEMMELIG" },
  },
  "security.vik": {
    sub: "dev-security-vik",
    name: "Morten Vik",
    firstName: "Morten",
    lastName: "Vik",
    email: "morten.vik@forsvaret.no",
    roles: ["security_officer"],
    accessToken: "dev-token-security-b",
    attributes: { employee_id: "FD-3002", site_id: "SITE-B", security_level: "HEMMELIG" },
  },
};
