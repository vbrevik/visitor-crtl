...
const DEV_USERS: Record<string, AuthUser> = {
  "visitor.norsk": {
    sub: "dev-visitor-norsk",
    name: "Ola Nordmann",
    firstName: "Ola",
    lastName: "Nordmann",
    email: "ola.nordmann@example.no",
    roles: ["visitor"],
    accessToken: "dev-token-visitor-norsk",
    attributes: { pid: "12345678901" },
  },
  "visitor.foreign": {
    sub: "dev-visitor-foreign",
    name: "Anna Lindqvist",
    firstName: "Anna",
    lastName: "Lindqvist",
    email: "anna.lindqvist@kongsberg.com",
    roles: ["visitor"],
    accessToken: "dev-token-visitor-foreign",
    attributes: {},
  },
  "contractor.admin": {
    sub: "dev-contractor-admin",
    name: "Petter Svendsen",
    firstName: "Petter",
    lastName: "Svendsen",
    email: "petter@leverandor.no",
    roles: ["visitor", "contractor_admin"],
    accessToken: "dev-token-contractor",
    attributes: {},
  },
};
